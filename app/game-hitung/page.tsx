...
const PetualanganHitungCeria = () => {
  ...
  // Load dan save game progress dari/ke localStorage
  const { completedLevels, setCompletedLevels, totalStars, setTotalStars } = useGameProgress('petualanganHitungProgress');
  ...
  if (gameState === 'levelSelect') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 p-4 sm:p-8 flex flex-col">
        <header className="w-full max-w-4xl mx-auto py-4 mb-4">
          <div className="bg-white/80 rounded-2xl shadow-lg py-3 px-6 text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-purple-700 tracking-wide drop-shadow-md">Eureka Playroom</h1>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 p-4 flex flex-col">
      <header className="w-full max-w-4xl mx-auto py-4 mb-4">
        <div className="bg-white/80 rounded-2xl shadow-lg py-3 px-6 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-purple-700 tracking-wide drop-shadow-md">Eureka Playroom</h1>
        </div>
            ...
            >
              {feedback === 'correct' ? (
                <>
                  ...
                  <p className="text-xl sm:text-3xl font-bold text-white animate-bounce drop-shadow-md">
                ...
                <>
                  ...
                  <p className="text-lg sm:text-xl text-white mt-3 drop-shadow-sm">Kamu pasti bisa!</p>
                </>
              )}
            </div>
            <style jsx>{`
